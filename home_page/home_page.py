...
geojson_sql = "SELECT COORDS FROM CBSA_DATA WHERE CITY_STATE = " + f"'{cbsa_selection}'" + "LIMIT 1"
...
INITIAL_VIEW_STATE = pdk.ViewState(latitude=geojson_dict['coordinates'][0][0][1], longitude=geojson_dict['coordinates'][0][0][0], zoom=12, max_zoom=16, pitch=45, bearing=0)
