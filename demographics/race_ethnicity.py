...
st.bar_chart(
  data = total_race_df[(total_race_df['Measure'].isin(race_filter)) & (total_race_df['FIVE_YEAR_ESTIMATE_DATE'] == total_race_df['FIVE_YEAR_ESTIMATE_DATE'].max())].sort_values(by=['Counts'], ascending = False),
  x = 'Measure',
  y = 'Counts',
  x_label = 'Total',
  y_label = 'Race',
